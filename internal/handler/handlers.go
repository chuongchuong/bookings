...
// "password" = $2a$12$T4qvHqN3I35wHS0nayIec.wEKVjGU6Mfv1zH84U8x0vHnKilMDxs.
// PostShowLogin hanldes logging the user in
...
func (m *Repository) AdminPostReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	...
	for _, x := range rooms {
		...
		for name, value := range curMap {
			// ok will be false if the values is not in the map
